...
//class ClanCreatedViewModel: ViewModel() {
//}

class ClanCreatedViewModel(
...
class ClanCreatedViewModelFactory(private val repoDeets: UserDetailsRepo, private val repositoryMyFriends: MyFriendsRepo) :
    ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ClanCreatedViewModel::class.java)) {
            @Suppress("UNCHECKED_CAST")
            return ClanCreatedViewModel(repoDeets, repositoryMyFriends) as T
        }
