package com.example.toastgoand.home.directtalk.camera
...
class CameraDirectActivity : BaseActivity() {
    private var imageCapture: ImageCapture? = null

    private lateinit var binding: ActivityCameraDirectBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = viewBinding as ActivityCameraDirectBinding
...
//        cameraExecutor.shutdown()
    ...
    override fun binding(): ViewBinding {
        return ActivityCameraDirectBinding.inflate(layoutInflater)
    }
}